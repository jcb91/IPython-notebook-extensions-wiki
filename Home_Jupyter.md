...
* There are no profiles anymore. You can specify environment variables to change the default.
* The configuration has moved to new places. To find out where, see below
