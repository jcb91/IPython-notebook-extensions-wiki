...
First install the notebook extensions repository on your local `.jupyter/nbextensions` directory. The new subdirectory is called `IPython-notebook-extensions-master`.
...
`/home/you/.jupyter/custom/custom.js`
